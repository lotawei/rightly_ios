...
class LVPageControl: UIControl {
    ...
    private var dotViewArray: [LVCustomDotView] = []
...
extension LVPageControl {
    ...
    private func updateDots() {
        ...
        for index in 0..<self.numberOfPages {
            var customDotView: LVCustomDotView?
    ...
    private func generateDotView() -> LVCustomDotView {
        
        let customDotView = LVCustomDotView()
    ...
    private func updateDotFrame(dotView: LVCustomDotView, index: Int) {
    ...
    private func changeActivity(active: Bool, index: Int) {
        ...
        let customDotView: LVCustomDotView = self.dotViewArray[index]
